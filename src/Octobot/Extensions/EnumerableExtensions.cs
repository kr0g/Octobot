...
namespace Octobot.Extensions
{
    public static class EnumerableExtensions
    {
        ...
        [Obsolete("Many of the usages of this are assuming that this is performing an assertion but it is actually just return a bool that isn't asserted.  Use Fluent Assertion instead .Should().HaveCount(x)")]
        public static bool HasExactly<T>(this IEnumerable<T> items, int expectedCount)
        {
        ...
        public static string BuildCommaSeparatedString<T>(this IEnumerable<T> list)
        {
            return list.BuildDeliminatedString(",");
        }
